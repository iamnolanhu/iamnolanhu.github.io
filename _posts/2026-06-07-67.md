...
image: /assets/images/blog/67/hero.png
date: 2026-06-07
author: Nolan Hu
...
We needed FRTC deployed, fast. Over the past year I'd built a set of [DigitalOcean skills for Claude](https://github.com/iamnolanhu/digitalocean-skills){:target="\_blank" rel="noopener noreferrer"}, the kind of unglamorous tooling that only pays off when someone else picks it up and it just works. My teammate [Buddhsen](https://x.com/senbuilds){:target="\_blank" rel="noopener noreferrer"} asked Claude to install those skills, dropped in an API key, and one-shot deployed the whole app. No hassle, no me hovering over his shoulder.

<div class="tweet-embed">
<blockquote class="twitter-tweet" data-dnt="true" data-theme="dark"><p lang="en" dir="ltr">IMO my biggest win that day was able to help my teammate to one shot deploy the app on <a href="https://x.com/digitalocean?ref_src=twsrc%5Etfw">@digitalocean</a>. <br><br>He asked claude to install my DO skills , dropped in an API key, and deployed it no hassle. <a href="https://t.co/AxAGbMxB06">https://t.co/AxAGbMxB06</a> <a href="https://t.co/3wjrpZJiqd">pic.twitter.com/3wjrpZJiqd</a></p>&mdash; Nolan (@nolanhu) <a href="https://x.com/nolanhu/status/2064201406685302955?ref_src=twsrc%5Etfw">June 9, 2026</a></blockquote> <script async src="https://platform.x.com/widgets.js" charset="utf-8"></script>
</div>
